...
const createPrompt = async (callback) => {
  ...
  /**
   * Função principal para capt-geturar entradas com base em um esquema.
   * @param {object} schema - Esquema das entradas.
   * @returns {Promise<object>} - Promessa com os dados capt-geturados.
   */
  const ask = (schema) =>
  ...
  /**
   * Função auxiliar para capt-geturar uma entrada simples.
  ...
  /**
   * Função auxiliar para capt-geturar uma entrada booleana.
