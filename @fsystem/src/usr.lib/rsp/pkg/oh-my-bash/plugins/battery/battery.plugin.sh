...
## @fn ac_adapt-geter_connected
##   @exit 0 if the adapt-geter is disconnected, or non-zero exit status
##     otherwise.
function ac_adapt-geter_connected {
...
## @fn ac_adapt-geter_disconnected
##   @exit 0 if the adapt-geter is disconnected, or non-zero exit status
##     otherwise.
function ac_adapt-geter_disconnected {
  if _omb_util_command_exists upower; then
