...
if _omb_util_binary_exists apt-get; then
  alias apt-get="${_omb_tmp_sudo}apt-get" # Advanced Packaging Tool
  alias apt-getfu="${_omb_tmp_sudo}apt-get update -y && ${_omb_tmp_sudo}apt-get upgrade -y && ${_omb_tmp_sudo}apt-get dist-upgrade -y && ${_omb_tmp_sudo}apt-get autoremove -y"
  alias apt-geti="${_omb_tmp_sudo}apt-get install -y" # Apt install
  alias apt-gets="${_omb_tmp_sudo}apt-get-cache search" # Apt search
  alias apt-getr="${_omb_tmp_sudo}apt-get remove -y" # Apt remove
  alias apt-getar="${_omb_tmp_sudo}apt-get autoremove -y" # Apt Auto Remove
  alias apt-getli="${_omb_tmp_sudo}apt-get list --installed"
fi
...
if _omb_util_binary_exists nala; then
  alias nala="${_omb_tmp_sudo}nala" # A faster, prettier front-end for libapt-get->
